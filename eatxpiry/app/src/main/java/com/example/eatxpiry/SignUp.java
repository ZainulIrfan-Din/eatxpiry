...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //enable clicking on login here text
                ...
                if(!fullname.equals("") && !username.equals("") && !password.equals("") && !email.equals("")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            //accessing signup.php file in localhost folders
                            PutData putData = new PutData("http://192.168.0.192/eatxpire/signup.php", "POST", field, data);
                            if (putData.startPut()){
