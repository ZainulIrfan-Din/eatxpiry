...
public class MEMBERSHARINGPAGE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_membersharingpage);
        ...
        backbutton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MEMBERSHARINGPAGE.this, MainActivity.class);
        ...
        addmember.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MEMBERSHARINGPAGE.this, com.example.eatxpiry.ADDMEMBERPAGE.class);
        ...
        deleteF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(),"Member successfully deleted!",Toast.LENGTH_SHORT).show();
            }
        });
